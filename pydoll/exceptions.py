...
class InvalidPreferencePath(ConfigurationException):
    """Raised when a provided preference path or value is invalid."""

    message = 'Invalid preference path or value for browser preferences'
