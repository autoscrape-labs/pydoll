...
class Tab(FindElementsMixin):  # noqa: PLR0904
    ...
    async def execute_script(
        ...
        """
        # Check for scripts that specifically use "argument." (element reference)
        # but don't provide element. This avoids false positives with JavaScript "arguments" object
        if 'argument.' in script and element is None:
            raise InvalidScriptWithElement(
                'Script contains "argument." but no element was provided'
            )
