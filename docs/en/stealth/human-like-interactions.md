...
<iframe scrolling="no" src="/docs/resources/visuals/typing-rhythm.html" aria-label="The same word typed at a fixed 50ms cadence versus a humanized rhythm with variable gaps and a corrected typo, plotted on one shared time axis" style="width: 100%; height: 340px; border: 0;" loading="lazy"></iframe>
