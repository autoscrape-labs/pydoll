...
- **Combine locale, fuso horário e geolocalização com o IP de saída.** O challenge cruza `Accept-Language` e o fuso horário contra o país do IP (veja [Incompatibilidade de locale/IP](../../stealth/fingerprint-injection.md#match-locale-and-timezone-to-your-egress-ip)). Num deployment real, essa costuma ser a única alavanca entre bloquear e passar.
