...
> 🎞️ **Placeholder visual interativo** — duas linhas do tempo de teclas para a mesma palavra: uma cadência fixa de 50ms versus o ritmo humanizado com intervalos variáveis e um erro de digitação corrigido.
